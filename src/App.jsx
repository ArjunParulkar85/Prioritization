...
const BRAND = "#D76400";
const STORAGE_KEY = "cxo_prioritizer_v1"; // local convenience cache (optional)
...
// local cache helpers (optional but nice)
const loadSaved = () => {
  try {
...
export default function App() {
  ...
  // autosave locally for convenience
  useEffect(() => {
  ...
  async function saveToCloud() {
    try {
      const payload = { rows, weights, dark };
  ...
  // Trello calls (using your proxy routes)
      ...
      <div style={{ maxWidth:1200, margin:"0 auto" }}>
        ...
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:16 }}>
          ...
          <div style={{ display:"flex", gap:8 }}>
            ...
            <button onClick={saveToCloud} style={{ padding:"6px 10px", border:`1px solid ${theme.border}`, background:"transparent", color:theme.color, borderRadius:8 }}>
              Save to Cloud
            </button>
            <button onClick={loadFromCloud} style={{ padding:"6px 10px", border:`1px solid ${theme.border}`, background:"transparent", color:theme.color, borderRadius:8 }}>
              Load from Cloud
            </button>
            <button onClick={resetAll} style={{ padding:"6px 10px", border:`1px solid ${theme.border}`, background:"transparent", color:theme.color, borderRadius:8 }}>
              Reset Data
            </button>
          </div>
        </div>
